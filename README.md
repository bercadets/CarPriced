...
*my first machine learning project - built on Feb 14 because I was curious how AI works and also bored.*

📝 Overview
I built this project to learn how machine learning actually works. It predicts car prices using features like brand, year, mileage, and engine size.

Did it work well? No, it was terrible hahaha.
Did I learn? Yup.
Was it fun? Yes, so cool to see it analyze a lot of data in a short amount of time.
...
🎯 Conclusion
The dataset appears to be artificially generated, with random prices that don't follow real-world patterns. Even the best machine learning model can't find patterns that don't exist! (I just used this dataset because it was the most recent one I found on Kaggle.)
...
⭐ If you read this far, thanks for checking out my first ML project!
